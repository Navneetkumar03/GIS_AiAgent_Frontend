...
// zones highlight for app2
import zoneGeoJsonRaw from '../assets/Delhi_zone.geojson?raw';
const zoneGeoJson = JSON.parse(zoneGeoJsonRaw);
...
export default function MapViewer({
    ...
    highlightedZones = [],   // new prop for zone highlighting
}) {
    ...
    return (
        <div className="relative h-full">
            ...
            >
                ...
                {/* ----  Highlighted Zones (App 2)  ---- */}
                {highlightedZones.length > 0 && (
                    <GeoJSON
                        key={highlightedZones.join(',')}
                        data={{
                            ...zoneGeoJson,
                            features: zoneGeoJson.features.filter(f =>
